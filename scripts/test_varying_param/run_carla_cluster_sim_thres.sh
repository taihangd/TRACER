...
sim_thres_list=("0.25" "0.3" "0.35" "0.4" "0.45")
adj_pt_ratio_list=("0.2" "0.35" "0.5" "0.65" "0.8" "0.95")
spher_distrib_coeff_list=("0.4" "0.55" "0.7" "0.85" "1.0")
...
do
    ...
    CUDA_VISIBLE_DEVICES=2 nohup /home/dth/miniconda3/envs/traj_rec/bin/python \
    -u  /home/dth/research/traj_recovery-main/test_cluster_carla.py \
    --cluster_sim_thres "$sim_thres" \
    --cluster_adj_pt_ratio "${adj_pt_ratio_list[1]}" \
